...
var I = 'setPrototypeOf' in Object,
  ...
  E = (function() {
    ...
    t.getAddress = function(t, e) {
      return b({ factoryAddress: '0xe3DcF89D0c90A877cD82283EdFA7C3Bd03e77E86', tokenA: t, tokenB: e })
    }
    var o = t.prototype
    return (
      ...
      for (var y = c.wrapped, v = u.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([].concat(s, [A]), o.currency, u), o, n.TradeType.EXACT_INPUT), h, C)
    ...
    (t.bestTradeExactOut = function(e, o, u, i, s, c, p) {
      ...
      for (var y = c.wrapped, v = o.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([A].concat(s), o, u.currency), u, n.TradeType.EXACT_OUTPUT), h, C)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
...
;(exports.FACTORY_ADDRESS = '0xe3DcF89D0c90A877cD82283EdFA7C3Bd03e77E86'),
