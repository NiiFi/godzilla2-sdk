...
var e = t(require('jsbi')),
  ...
  i = '0x0afcd21f90e27818df9c484881aac8a20b869cbd86156c655d2020ef6950a5ba',
  s = e.BigInt(1e3),
  a = e.BigInt(0),
  c = e.BigInt(1),
  p = e.BigInt(5),
...
var I = 'setPrototypeOf' in Object,
  ...
  E = (function() {
    ...
    t.getAddress = function(t, e) {
      return b({ factoryAddress: '0x11AB0Ca40B2E9Bf2c98718539cA1aD7486999E57', tokenA: t, tokenB: e })
    }
    var o = t.prototype
    return (
      ...
      (o.getOutputAmount = function(o) {
        ...
        if (e.equal(f.quotient, a)) throw new O()
      ...
      for (var y = c.wrapped, v = u.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([].concat(s, [A]), o.currency, u), o, n.TradeType.EXACT_INPUT), f, C)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactIn(k, o, u, { maxNumResults: f, maxHops: d - 1 }, [].concat(s, [A]), q, p)
          }
        }
      }
      return p
    ...
    (t.bestTradeExactOut = function(e, o, u, i, s, c, p) {
      ...
      for (var y = c.wrapped, v = o.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([A].concat(s), o, u.currency), u, n.TradeType.EXACT_OUTPUT), f, C)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactOut(k, o, u, { maxNumResults: f, maxHops: d - 1 }, [A].concat(s), q, p)
          }
        }
      }
      return p
...
;(exports.FACTORY_ADDRESS = '0x11AB0Ca40B2E9Bf2c98718539cA1aD7486999E57'),
